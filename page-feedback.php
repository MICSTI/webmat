We are constantly trying to improve this tool so we are happy about every feedback and ideas on how we can make it better. Please take a few moments and share your thoughts. Thank you very much!

<section class="webmat-survey-container">
	<form action="/survey" method="post">
		<input type='hidden' id='request-id' name='request-id' value='_feedback' />
...
<script type="text/javascript">
  function toggleDisplay(_id) {
    ...
    var plus = document.getElementById(_id + '-plus');
    var minus = document.getElementById(_id + '-minus');
