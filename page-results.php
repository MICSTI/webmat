						...
						<section class="webmat-survey-container">
							<div class="survey-paragraph">
								<div class="survey-title">
									Do you mind telling us something about you and your study? Please take a moment and fill out the questions below.
								</div>
							</div>
							...
							<div class="survey-paragraph">
								...
								<div class="survey-paragraph-question" id="p-helpful">
									<div><input id="q-helpful" name="q-helpful" type="radio" value="yes" /><span> Yes, I know now better which measurement I can use.</span></div>
									<div><input id="q-helpful" name="q-helpful" type="radio" value="no" /><span> No, I still don't know which measurement I can use.</span></div>
								</div>
							</div>
							...
							<div class="survey-paragraph">
								...
								<div class="survey-paragraph-question" id="p-purpose">
									<input id="q-purpose" name="q-purpose" type="text" size="40"/>
								</div>
							</div>
							...
							<div class="survey-paragraph">
								...
								<div class="survey-paragraph-question" id="p-occupation">
									<div><input id="q-occupation" name="q-occupation" type="radio" value="student" /><span> Student</span></div>
									<div><input id="q-occupation" name="q-occupation" type="radio" value="researcher" /><span> Researcher (including PhD)</span></div>
									<div><input id="q-occupation" name="q-occupation" type="radio" value="professor_academic" /><span> Professor/Academic</span></div>
									<div><input id="q-occupation" name="q-occupation" type="radio" value="policy_maker" /><span> Policy Maker</span></div>
									<div><input id="q-occupation" name="q-occupation" type="radio" value="health_professional" /><span> Health Professional</span></div>
									<div><input id="q-occupation" name="q-occupation" type="radio" value="volunteer" /><span> Volunteer</span></div>
									<div><input id="q-occupation" name="q-occupation" type="radio" value="charity_worker" /><span> Charity Worker</span></div>
									<div><input id="q-occupation" name="q-occupation" type="radio" value="other" /><span> Other</span></div>
							...
							<div class="survey-paragraph">
								...
								<div class="survey-paragraph-question" id="p-based">
									<input id="q-based" name="q-based" type="text" size="40"/>
								</div>
							</div>
							...
							<div class="survey-paragraph">
								...
								<div class="survey-paragraph-question" id="p-funded">
									<div><input id="q-funded" name="q-funded" type="radio" value="yes" /><span>Yes</span></div>
									<div><input id="q-funded" name="q-funded" type="radio" value="no" /><span>No</span></div>
								</div>
							</div>
							...
							<div class="survey-paragraph">
								...
								<div class="survey-paragraph-question" id="p-reco">
									<div><input id="q-reco" name="q-reco" type="radio" value="yes" /><span> Yes</span></div>
									<div><input id="q-reco" name="q-reco" type="radio" value="no" /><span> No</span></div>
								</div>
							</div>
